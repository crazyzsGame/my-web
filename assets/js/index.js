...
const apiCall = () => {
    try {
        ...
        fetch(`https://raw.githubusercontent.com/jd0703-jenish/Kfglgames/main/api2.json`)
        ...
        objKey?.forEach((key) => {
            ...
            gamee4[key]?.forEach((game, index) => {
                if (game?.category == key) {
                    ...
                    div.innerHTML += `
                    <div class="game-containerMain"  id="gameDiv${index}" onclick="setGamesObj('${key}',${index})">
